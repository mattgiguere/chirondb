...
class chironObject:
    ...
    def getRawChironInformation(self):
        ...
        if (obs_dec[0] != 'NULL' and obs_dec[0] != 'dec' and obs_dec[0] != 'NaN'):
        ...
        #print('ha is: ', ha)
        if (ha[0] != 'NULL' and ha[0] != 'hour_angle' and ha[0] != '2000.0'):
            if (float(ha[0]) < 0):
        ...
        #print('st is: ', st)
        if (st[0] !='NULL' and st[0] != 'sidereal_time' and st[2] != '0NaN'):
